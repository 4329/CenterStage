...
public class FrcPidController implements AutoCloseable {
     ...
     */
    public FrcPidController(double kp, double ki, double kd) {
        this(kp, ki, kd, 0.02);
    }
     ...
     */
    public FrcPidController(double kp, double ki, double kd, double period) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
